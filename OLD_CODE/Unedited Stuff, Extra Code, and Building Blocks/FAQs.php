		...
		echo "<td align = 'center' valign = 'top'>"; // COLUMN2
			echo "<table style = 'width: 970px; margin-left: 10px'>"; // TABLE inside COLUMN2
				echo "<tr>"; // ROW 1 of TABLE inside COLUMN2
					...
					echo "<b><font face = 'Calibri' size = '5' color = '#2E2E2E'>Frequently Asked Questions (FAQs) </font></b><font face = 'Calibri' size = '4' color = '#ccc'> about </font><b><font face = 'Calibri' size = '5' color = '#63BA33'>LyfSync</b></font></b></td>";
				echo "</tr>";
